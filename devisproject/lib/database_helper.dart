...
class DatabaseHelper {
  ...
  static final columnApellidos = 'apellidos';
  static final columnEmail = 'email';
  static final columnContrasenya = 'contrasenya';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE $table (
            ...
            $columnContrasenya TEXT NOT NULL
          )
          ''');
  }
  ...
  Future<List<Map<String, dynamic>>> queryRows(nombre) async {
    Database db = await instance.database;
    return await db.query(table, where: "$columnName LIKE '%$nombre%'");
  }
}
